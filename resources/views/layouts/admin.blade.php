...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-surface-gray text-slate-950 antialiased">
        @php
            $adminUser = auth()->user();
            ...
            $navItems = [
                ...
                ['label' => 'Analisis Spasial', 'href' => route('admin.spatial-analysis.index'), 'active' => request()->routeIs('admin.spatial-analysis.*'), 'icon' => 'M4.75 18.25 9 14l3 2.5 7.25-8.75M6.5 8.5a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm11 11a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z'],
            ...
            <aside class="border-b border-outline-variant/70 bg-white/95 lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:w-[280px] lg:border-b-0 lg:border-r">
                ...
                <div class="hidden border-t border-outline-variant/70 px-4 py-4 lg:block">
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-3">
                        ...
                        <p class="mt-2 text-sm font-semibold text-primary">Auth dan CRUD Banjir Aktif</p>
                        <p class="mt-1 text-xs leading-5 text-slate-500">Modul lain, GeoJSON, dan dashboard data real belum diaktifkan.</p>
                    </div>
                    <div class="mt-4 space-y-1">
                        <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-500 transition hover:bg-slate-100 hover:text-primary">Panduan</a>
                        <a href="#" class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-500 transition hover:bg-slate-100 hover:text-primary">Bantuan</a>
